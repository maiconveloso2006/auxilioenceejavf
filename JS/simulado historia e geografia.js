document.addEventListener('DOMContentLoaded', function() {
            ...
            // Atualizar o total de questões na interface
            ...
            function showQuestion(number) {
                ...
                if (number === totalQuestions) {
                    ...
                    nextBtn.innerHTML = 'Próxima Questão <i class="fas fa-arrow-right"></i>';
                }
            ...
            function finishSimulado() {
                ...
                // Salvar a última resposta, se houver
                saveAnswer();
                ...
                if (score === totalQuestions) {
                    resultMessage.textContent = 'Parabéns! Você acertou todas as questões. Você está pronto para o exame!';
                } else if (score >= totalQuestions * 0.7) {
                    resultMessage.textContent = 'Ótimo desempenho! Você está bem preparado para o exame.';
                } else if (score >= totalQuestions * 0.5) {
                    resultMessage.textContent = 'Bom esforço! Continue estudando para melhorar sua pontuação no exame.';
                } else {
