// Variáveis globais
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Configurar limite de trocas de aba
            document.getElementById('maxTabSwitches').textContent = MAX_TAB_SWITCHES;
        });
        ...
        function showResults() {
            ...
            if (score === totalExercises) {
                message = 'Parabéns! Você acertou todas as questões. Você tem um excelente conhecimento da história do Brasil.';
            } else if (score >= totalExercises * 0.8) {
                message = 'Excelente! Você tem um bom domínio da história do Brasil. Continue estudando para perfeccionar seus conhecimentos.';
            } else if (score >= totalExercises * 0.6) {
                message = 'Bom trabalho! Você tem um conhecimento razoável da história do Brasil. Continue estudando para melhorar ainda mais.';
            } else if (score >= totalExercises * 0.4) {
                message = 'Você está no caminho certo. Continue estudando e praticando para melhorar seus conhecimentos da história do Brasil.';
            } else {
                message = 'Recomendamos que você estude mais sobre a história do Brasil. Consulte livros e fontes confiáveis para melhorar seus conhecimentos.';
            }
        ...
        function restartQuiz() {
            ...
            document.getElementById('colonizacao').classList.add('active');
