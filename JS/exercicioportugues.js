// Variáveis globais
        ...
        function checkAnswer(exerciseId, correctAnswer) {
            ...
            // Atualizar pontuação apenas se ainda não foi contabilizada
        ...
        function showResults() {
            ...
            if (score === totalExercises) {
                message = 'Parabéns! Você acertou todas as questões. Você tem um excelente conhecimento de português.';
            } else if (score >= totalExercises * 0.8) {
                message = 'Excelente! Você tem um bom domínio dos conceitos de português. Continue estudando para aperfeiçoar seus conhecimentos.';
            } else if (score >= totalExercises * 0.6) {
                message = 'Bom trabalho! Você tem um conhecimento razoável de português. Continue estudando para melhorar ainda mais.';
            } else if (score >= totalExercises * 0.4) {
                message = 'Você está no caminho certo. Continue estudando e praticando para melhorar seus conhecimentos de português.';
            } else {
                message = 'Recomendamos que você estude mais sobre português. Consulte livros e fontes confiáveis para melhorar seus conhecimentos.';
            }
        ...
        function restartQuiz() {
            ...
            document.getElementById('ortografia').classList.add('active');
