// Variáveis globais
        ...
        function checkAnswer(exerciseId, correctAnswer) {
            ...
            // Verificar se o exercício já foi respondido
            if (exercise.querySelector('.btn-check').disabled) {
                return;
            }
            ...
            // Atualizar número de exercícios respondidos
            answeredExercises++;
            updateProgress();
        ...
        function showResults() {
            ...
            if (score === totalExercises) {
                message = 'Parabéns! Você acertou todas as questões. Você tem um excelente conhecimento de geografia.';
            } else if (score >= totalExercises * 0.8) {
                message = 'Excelente! Você tem um bom domínio dos conceitos de geografia. Continue estudando para aperfeiçoar seus conhecimentos.';
            } else if (score >= totalExercises * 0.6) {
                message = 'Bom trabalho! Você tem um conhecimento razoável de geografia. Continue estudando para melhorar ainda mais.';
            } else if (score >= totalExercises * 0.4) {
                message = 'Você está no caminho certo. Continue estudando e praticando para melhorar seus conhecimentos de geografia.';
            } else {
                message = 'Recomendamos que você estude mais sobre geografia. Consulte livros e fontes confiáveis para melhorar seus conhecimentos.';
            }
        ...
        function restartQuiz() {
            ...
            document.querySelectorAll('.exercise').forEach(exercise => {
                ...
                exercise.querySelector('.btn-check').disabled = false;
                exercise.querySelector('.btn-check').textContent = 'Verificar';
            });
            ...
            document.getElementById('fisica').classList.add('active');
        }
        ...
        // Modificar a função showResults() para incluir a desativação do bloqueio
        function showResults() {
            document.querySelectorAll('.exercise').forEach(exercise => {
                exercise.style.display = 'none';
            });
        ...
        // Modificar a função restartQuiz() para reativar o bloqueio de tela
        function restartQuiz() {
            // Reiniciar pontuação e contadores
            score = 0;
            answeredExercises = 0;
