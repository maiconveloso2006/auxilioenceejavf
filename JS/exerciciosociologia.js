// Variáveis globais
        ...
        function showResults() {
            ...
            if (score === totalExercises) {
                message = 'Parabéns! Você acertou todas as questões. Você tem um excelente conhecimento de sociologia.';
            } else if (score >= totalExercises * 0.8) {
                message = 'Excelente! Você tem um bom domínio dos conceitos de sociologia. Continue estudando para aperfeiçoar seus conhecimentos.';
            } else if (score >= totalExercises * 0.6) {
                message = 'Bom trabalho! Você tem um conhecimento razoável de sociologia. Continue estudando para melhorar ainda mais.';
            } else if (score >= totalExercises * 0.4) {
                message = 'Você está no caminho certo. Continue estudando e praticando para melhorar seus conhecimentos de sociologia.';
            } else {
                message = 'Recomendamos que você estude mais sobre sociologia. Consulte livros e fontes confiáveis para melhorar seus conhecimentos.';
            }
        ...
        function restartQuiz() {
            ...
            document.getElementById('conceitos').classList.add('active');
