// Variáveis globais
        ...
        function showResults() {
            ...
            if (score === totalExercises) {
                message = 'Parabéns! Você acertou todas as questões. Você tem um excelente conhecimento das áreas de física, química e biologia.';
            } else if (score >= totalExercises * 0.8) {
                message = 'Excelente! Você tem um bom domínio das áreas de física, química e biologia. Continue praticando para aperfeiçoar seus conhecimentos.';
            } else if (score >= totalExercises * 0.6) {
                message = 'Bom trabalho! Você tem um conhecimento razoável nas áreas de física, química e biologia. Continue estudando e praticando para melhorar ainda mais.';
            } else if (score >= totalExercises * 0.4) {
                message = 'Você está no caminho certo. Continue estudando e praticando para aprimorar seu conhecimento nas áreas de física, química e biologia.';
            } else {
                message = 'Recomendamos que você revise os conceitos básicos de física, química e biologia. Continue praticando para melhorar seu desempenho.';
            }
