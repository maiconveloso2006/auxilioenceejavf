...
const translations = {
    'pt-BR': {
        ...
        'student.class_info': 'Turma: ENCCEJA 2026 | Matricula: ',
        'student.level_prefix': 'Nivel: ',
        'a11y.font_small': 'Pequeno',
        'a11y.font_normal': 'Normal',
        'a11y.font_large': 'Grande',
        'a11y.font_xlarge': 'Muito Grande',
        'a11y.line_compact': 'Compacto',
        'a11y.line_normal': 'Normal',
        'a11y.line_spaced': 'Espaçado',
        'toast.settings_saved': 'Configurações salvas com sucesso!',
    },
    ...
    'en': {
        ...
        'student.class_info': 'Class: ENCCEJA 2026 | ID: ',
        'student.level_prefix': 'Level: ',
        'a11y.font_small': 'Small',
        'a11y.font_normal': 'Normal',
        'a11y.font_large': 'Large',
        'a11y.font_xlarge': 'Extra Large',
        'a11y.line_compact': 'Compact',
        'a11y.line_normal': 'Normal',
        'a11y.line_spaced': 'Spaced',
    ...
    'es': {
        ...
        'student.class_info': 'Clase: ENCCEJA 2026 | Matrícula: ',
        'student.level_prefix': 'Nivel: ',
        'a11y.font_small': 'Pequeño',
        'a11y.font_normal': 'Normal',
        'a11y.font_large': 'Grande',
        'a11y.font_xlarge': 'Muy Grande',
        'a11y.line_compact': 'Compacto',
        'a11y.line_normal': 'Normal',
        'a11y.line_spaced': 'Espaciado',
        'toast.settings_saved': '¡Configuraciones guardadas con éxito!',
    }
};
...
function setLanguage(lang) {
    ...
    // Re-gera atividades recentes padrão com o novo idioma (quando não há dados da API)
    if (!apiTarefas.length) recentActivities = getDefaultRecentActivities();
    if (activityList) renderActivities();
    if (typeof renderApiTasksList === 'function') renderApiTasksList();
...
const subjectsData = [
    {
        id: 1,
        nameKey: 'data.subject.math.name',
        icon: "bi-calculator",
        ...
        topics: [
            {
                nameKey: 'data.subject.math.t0.name', status: "completed", progress: 100, activities: [
                    { type: "video", nameKey: 'data.subject.math.t0.act0.name', status: "completed", score: null },
                    { type: "exercise", nameKey: 'data.subject.math.t0.act1.name', status: "completed", score: "95%" }
                ]
            },
            {
                nameKey: 'data.subject.math.t1.name', status: "completed", progress: 100, activities: [
                    { type: "video", nameKey: 'data.subject.math.t1.act0.name', status: "completed", score: null },
                    { type: "exercise", nameKey: 'data.subject.math.t1.act1.name', status: "completed", score: "82%" }
                ]
            },
            {
                nameKey: 'data.subject.math.t2.name', status: "in-progress", progress: 60, activities: [
                    { type: "video", nameKey: 'data.subject.math.t2.act0.name', status: "completed", score: null },
                    { type: "video", nameKey: 'data.subject.math.t2.act1.name', status: "pending", score: null }
                ]
            }
        ]
    },
    {
        id: 2,
        nameKey: 'data.subject.portuguese.name',
        icon: "bi-chat-quote",
        ...
        topics: [
            {
                nameKey: 'data.subject.portuguese.t0.name', status: "completed", progress: 100, activities: [
                    { type: "video", nameKey: 'data.subject.portuguese.t0.act0.name', status: "completed", score: null },
                    { type: "exercise", nameKey: 'data.subject.portuguese.t0.act1.name', status: "completed", score: "92%" }
                ]
            },
            {
                nameKey: 'data.subject.portuguese.t1.name', status: "in-progress", progress: 70, activities: [
                    { type: "video", nameKey: 'data.subject.portuguese.t1.act0.name', status: "completed", score: null },
                    { type: "simulado", nameKey: 'data.subject.portuguese.t1.act1.name', status: "pending", score: null }
                ]
            }
        ]
    },
    {
        id: 3,
        nameKey: 'data.subject.history.name',
        icon: "bi-bank",
        colorClass: "historia",
        progress: 55,
        completed: 11,
        ...
        topics: [
            {
                nameKey: 'data.subject.history.t0.name', status: "completed", progress: 100, activities: [
                    { type: "video", nameKey: 'data.subject.history.t0.act0.name', status: "completed", score: null }
                ]
            },
            {
                nameKey: 'data.subject.history.t1.name', status: "in-progress", progress: 50, activities: [
                    { type: "video", nameKey: 'data.subject.history.t1.act0.name', status: "completed", score: null },
                    { type: "exercise", nameKey: 'data.subject.history.t1.act1.name', status: "pending", score: null }
                ]
            }
        ]
    },
    {
        id: 4,
        nameKey: 'data.subject.geography.name',
        ...
        topics: [
            {
                nameKey: 'data.subject.geography.t0.name', status: "completed", progress: 100, activities: [
                    { type: "exercise", nameKey: 'data.subject.geography.t0.act0.name', status: "completed", score: "72%" }
                ]
            }
        ]
    },
    {
        id: 5,
        nameKey: 'data.subject.science.name',
        icon: "bi-lightning",
        colorClass: "ciencias",
        progress: 63,
        completed: 15,
        ...
        topics: [
            {
                nameKey: 'data.subject.science.t0.name', status: "completed", progress: 100, activities: [
                    { type: "video", nameKey: 'data.subject.science.t0.act0.name', status: "completed", score: null }
                ]
            }
        ]
    },
    {
        id: 6,
        nameKey: 'data.subject.english.name',
        icon: "bi-translate",
        colorClass: "ingles",
        progress: 40,
        completed: 8,
        ...
        topics: [
            {
                nameKey: 'data.subject.english.t0.name', status: "in-progress", progress: 30, activities: [
                    { type: "video", nameKey: 'data.subject.english.t0.act0.name', status: "completed", score: null }
                ]
            }
        ]
    }
...
function getDefaultRecentActivities() {
    return [
        { icon: "bi-check-circle", type: "success", title: t('data.recent.act0.title'), meta: t('data.recent.act0.meta'), time: t('time.ago') + ' 2 ' + t('time.hours') },
        { icon: "bi-play-circle", type: "info", title: t('data.recent.act1.title'), meta: t('data.recent.act1.meta'), time: t('time.ago') + ' 5 ' + t('time.hours') },
        { icon: "bi-trophy", type: "warning", title: t('data.recent.act2.title'), meta: t('data.recent.act2.meta'), time: t('time.yesterday') }
    ];
}
    ...
    list.innerHTML = apiTarefas.map(function (tarefa) {
        ...
        return `
            <div class="activity-card api-task-card" data-tarefa-id="${tarefa.id}">
                <button type="button" class="activity-card-icon ${done ? 'success' : 'pending'} api-task-toggle" title="${done ? t('ui.statusPending') : t('ui.statusDone')}" aria-label="Alternar status">
                ...
                <div class="activity-card-time">${done ? t('ui.statusDone') : t('ui.statusPending')}</div>
            </div>`;
    }).join('');
...
document.addEventListener('DOMContentLoaded', async function () {
    await loadTarefasFromApi();
    // Se não há tarefas da API, preenche com as atividades padrão traduzidas
    if (!apiTarefas.length) recentActivities = getDefaultRecentActivities();
    renderSubjects();
    renderActivities();
    renderApiTasksList();
...
function createSubjectCard(subject) {
    ...
    const subjectName = t(subject.nameKey);
    return `
                    ...
                    <div class="subject-card-header">
                        ...
                        <div class="subject-main-info">
                            ...
                            <div class="subject-meta">
                                <i class="bi bi-collection"></i> ${subject.completed}/${subject.total} ${t('ui.activities')}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="subject-card-body">
                        ...
                        <div class="subject-stats-new">
                            <div class="stat-pill">
                                ...
                                <span class="stat-pill-label">${t('ui.completed')}</span>
                            </div>
                            <div class="stat-pill">
                                <span class="stat-pill-value">${subject.total - subject.completed}</span>
                                <span class="stat-pill-label">${t('ui.pending')}</span>
                            </div>
                            <div class="stat-pill">
                                <span class="stat-pill-value">${subject.average}%</span>
                                <span class="stat-pill-label">${t('ui.average')}</span>
                            </div>
                        </div>
                        
                        <button class="card-view-btn">
                            ${t('ui.viewTopics')} <i class="bi bi-arrow-right"></i>
                        </button>
                    </div>
                </div>
            `;
    ...
    activityList.innerHTML = recentActivities.map(activity => `
                <div class="activity-card">
                    ...
                    <div class="activity-card-content">
                        ...
                        <div class="activity-card-meta">${activity.meta}</div>
                    </div>
    ...
    detailContent.innerHTML = `
                ...
                <div class="detail-header">
                    ...
                    <div class="detail-info">
                        <h2 class="detail-label">${subjectName}</h2>
                        <p class="detail-label">${subject.completed} ${t('ui.completed').toLowerCase()} / ${subject.total} ${t('ui.activities').toLowerCase()}</p>
...
function createTopicCard(topic, index) {
    return `
            ...
            topic.status === 'in-progress' ? '<i class="bi bi-arrow-repeat"></i>' : ''}
                            ...
                            <div>
                                <div class="topic-name">${t(topic.nameKey)}</div>
                                <div class="topic-meta">${topic.activities.length} ${t('ui.topics')}</div>
                            </div>
                        </div>
                    ...
                    activity.type === 'exercise' ? 'bi-pencil' : 'bi-clipboard-check'}"></i>
                                        ...
                                        <div class="activity-name">${t(activity.nameKey)}</div>
                                    </div>
...
function initAccessibilityModal() {
    ...
    fontSizeRange.addEventListener('input', function () {
        const sizes = [t('a11y.font_small'), t('a11y.font_normal'), t('a11y.font_large'), t('a11y.font_xlarge')];
    ...
    lineHeightRange.addEventListener('input', function () {
        const heights = [t('a11y.line_compact'), t('a11y.line_normal'), t('a11y.line_spaced')];
...
function resetAccessibilitySettings() {
    ...
    document.getElementById('fontSizeValue').textContent = t('a11y.font_normal');
    document.getElementById('lineHeightValue').textContent = t('a11y.line_normal');
