document.addEventListener('DOMContentLoaded', function() {
            ...
            // Adicionar evento de clique nas opções para feedback imediato
            ...
            function startTimer() {
                timer = setInterval(function() {
                    ...
                    // Verificar se atingiu o tempo limite (60 minutos)
                    if (minutes >= 60) {
                        finishSimulado();
                    }
                }, 1000);
            ...
            function showQuestion(number) {
                ...
                if (savedAnswer) {
                    const selectedOption = document.querySelector(`input[name="q${number}"][value="${savedAnswer}"]`);
                    if (selectedOption) {
                ...
                // Limpar feedback
                const feedbackEl = document.getElementById(`feedback-${number}`);
                if (feedbackEl) {
            ...
            function resetSimulado() {
                ...
                // Esconder o container de questões
                questionContainer.style.display = 'none';
